...
secrets_path = os.path.abspath('../authentication/slack_internal/secrets.json');
...
class IndexHandler(web.RequestHandler):
    def get(self):
        self.write('<a href="https://slack.com/oauth/authorize?scope=identify,read,post,client,apps&client_id=2171079607.68505416229"><img alt="Add to Slack" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" srcset="https://platform.slack-edge.com/img/add_to_slack.png 1x, https://platform.slack-edge.com/img/add_to_slack@2x.png 2x" /></a>')
        self.finish()

(function() {
  ...
  function flameGraph() {
    ...
    var w = 960, // graph width
      ...
      sort = true,
      reversed = true, // reverse the graph direction
      clickHandler = null;
    ...
    function update() {
      ...
      selection.each(function(data) {
        ...
        g.transition()
          ...
          .ease(transitionEase)
          .attr("transform", function(d) {  return "translate(" + ((reversed ? y(d.depth) : (h - y(d.depth) - c)) ) + ","
            + x(d.x) + ")"; });
        ...
        g.select("rect").transition()
          .duration(transitionDuration)
          .ease(transitionEase)
          .attr("height", function(d) { return d.dx * kx; });
        ...
        g.attr("height", function(d) { return d.dx * kx; })
          .attr("width", function(d) { return c; })
        ...
        g.select("foreignObject")
          ...
          .select("div")
          .attr("class", "label")
          .style("display", function(d) { return (d.dx * kx < 15) || d.dummy ? "none" : "block";})
          // .style("display", function(d) { return d.dummy ? "none" : "block";})
          .text(name);

...
from advertiserdatabase import AdvertiserDatabase
from advertiserapi import AdvertiserAPI
from base import BaseHandler

class AdvertiserHandler(BaseHandler, AdvertiserDatabase, AdvertiserAPI):

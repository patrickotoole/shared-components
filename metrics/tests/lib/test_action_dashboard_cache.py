...
class ActionCacheTestCase(unittest.TestCase):
    ...
    def test_segments_failure1(self):
        self.instance.auth()
        self.instance.req.get.side_effect = mock.MagicMock(side_effect=buildHelper(JSON_FIXTURE_6))
        segments = self.instance.get_segments()
        return segments

    def test_segments_failure1(self):
        self.instance.auth()
        self.instance.req.get.side_effect = mock.MagicMock(side_effect=buildHelper(JSON_FIXTURE_7))
        segments = self.instance.get_segments()
        return segments
    ...
    def test_request_succes_one_record(self):
        ...
        side_res = self.instance.make_request("pattern", "advertiser", 1, "action")
        self.assertEqual(type(side_res), type(pandas.DataFrame()))
        self.assertTrue(len(side_res)==1)
    ...
    def test_request_succes_multiple_record(self):
        ...
        side_r = self.instance.make_request("pattern", "advertiser", 1, "action")
        self.assertEqual(type(side_r), type(pandas.DataFrame()))
        self.assertTrue(len(side_r)==3)
    ...
    def test_request_failure_no_data(self):
        ...
        r = self.instance.make_request("pattern", "advertiser", 1, "action")

    ...
    **/
    ...
    function drawDots(chartBody, layers) {
        if (!_chart.brushOn()) {
			...
			// NO GOOD, NO TEMPLATE
			var graphPos = $('#campaign-graph').position();	
            ...
            layers.each(function (d, layerIndex) {
                ...
                dots.enter()
                    ...
                    .on("mousemove", function (d) {
						...
						.html('<img src="http://rockerbox.com/assets/img/dashboard/general/tooltip.png" alt="Tooltip" /><span class="tooltip-content">' + formatTime(d.x) + "<span>" + tooltipValue + "</span></span>")
						.style("left", parseInt(parseInt(dot.attr("cx")) + graphPos.left + 8) + "px")     
						.style("top", parseInt(parseInt(dot.attr("cy")) + graphPos.top - 8) + "px");    	
...
dc.customDataBox = function (parent, chartGroup) {
    ...
    **/
	...
	_chart.groupSelect = function(_) {
        if (!arguments.length) return _groupSelect;
        _groupSelect = _;
        return _chart;
    };
...
dc.customDataTable = function(parent, chartGroup) {
    ...
    **/
    _chart.listItems = function(_) {
        if (!arguments.length) return _listItems;
        _listItems = _;
        return _chart;
    };

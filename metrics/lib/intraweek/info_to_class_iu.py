...
class Intraweek:
    ...
    def read_advinfo_from_db(self, advertiser_id):
        ...
        self.money_spent = self.get_cumulative_clientcharge(advertiser_id)
        ...
        self.dollars_remaining = self.get_dollars_remaining(advertiser_id)
        self.days_into_campaign = self.get_days_into_campaign(advertiser_id)
        self.proposed_campaign_length = self.get_proposed_campaign_length(advertiser_id)
        self.current_start_date = self.get_current_start_date(advertiser_id)
        self.end_date_proposed = self.get_end_date_proposed(advertiser_id)
    ...
    def display_advinfo(self, advertiser_id):
        map = { 'advertiser': [self.advertiser_name],
                ...
                'days_left': [int(self.expected_campaign_length) - self.days_into_campaign],
                '$_per_day': [self.dollars_per_day],

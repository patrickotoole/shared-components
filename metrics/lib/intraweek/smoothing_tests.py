...
class SmoothCharges:
    ...
    def get_cpm_multiplier(self, advertiser_id):
        mult_df = self.my_db.select('select cpm_multiplier from intraweek where external_advertiser_id = (%d)' % advertiser_id).as_dataframe()

...
class KafkaHandler(logging.StreamHandler):
    ...
    def emit(self, record):
        try:
            ...
            msg = {"version":"1.1", "short_message":record.getMessage(), "source":"chronos","host":"slavex", "application":"chronos", "app_name":self.app_name+"."+socket.gethostname(),"location":record.name+"-"+record.pathname+":"+str(record.lineno)}

...
URL = RB_API_BASE + "?meta=none&include=domain&date=%s&format=json&campaign=%s&advertiser_equal=%s&static_type=%s" 
...
class DomainAPI(object):
    ...
    def update_domain_list(self,domains,external_id,domain_list,action):
        ...
        _existing = self.get_existing_domains(external_id) or []

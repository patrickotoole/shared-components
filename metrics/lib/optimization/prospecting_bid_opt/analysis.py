...
DF_COLS = ['CPM_daily', 'clicks', 'imps_served_daily', 'imps_served_total', 
            'last_served_date', 'media_cost', 'total_conv', 'max_bid', 
            'campaign_state', 'learn_total_imps_limit', 'learn_daily_imps_limit', 
            'learn_daily_cpm_limit', 'learn_max_bid_limit', 'loss_limit']

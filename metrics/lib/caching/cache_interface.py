...
class CacheInterface:
    ...
    def add_to_work_queue(self, segment, advertiser):
        ...
        CustomQueue(self.zookeeper,"python_queue").put(work,5)
    ...
    def add_db_to_work_queue(self, segment, advertiser, base_url):
        ...
        CustomQueue(self.zookeeper,"python_queue").put(work,20)
    ...
    def add_full_url_to_work_queue(self, segment, advertiser, base_url):
        ...
        CustomQueue(self.zookeeper,"python_queue").put(work,30)
    ...
    def add_udf_to_work_queue(self, segment, advertiser, base_url):
        ...
        CustomQueue(self.zookeeper,"python_queue").put(work,31)
        ...
        CustomQueue(self.zookeeper,"python_queue").put(work,39)
        logging.info("added udf to work queue for %s %s" %(segment,advertiser))
        ...
        CustomQueue(self.zookeeper,"python_queue").put(work,35)
        logging.info("added udf to work queue for %s %s" %(segment,advertiser))
